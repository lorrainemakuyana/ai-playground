...
import { getProjects, logout, ApiError } from "@/lib/api";
...
export default function AppHomePage() {
  ...
  const load = useCallback(async () => {
    try {
      ...
      // A 401 means the session is invalid (e.g. a stale auth cookie); fetchJSON
      // already redirects to /auth. Showing the "backend offline" banner here
      // just flashes a misleading error during that redirect, so swallow it.
